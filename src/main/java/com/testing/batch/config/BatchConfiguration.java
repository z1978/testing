//package com.testing.batch.config;
//
//import java.sql.ResultSet;
//
//import javax.sql.DataSource;
//
//import com.testing.batch.listener.JobCompletionNotificationListener;
//import com.testing.batch.model.RecordSO;
//import com.testing.batch.model.WriterSO;
//import com.testing.batch.processor.RecordProcessor;
//
...
//        return new JdbcCursorItemReaderBuilder<RecordSO>()
//        		.name("the-reader")
//                .sql("select id, firstName, lastname, random_num from reader")
...
//                .sql("insert into writer (id, full_name, random_num) values (?,?,?)")
//                .dataSource(dataSource)
//                .build();
//    }
//
